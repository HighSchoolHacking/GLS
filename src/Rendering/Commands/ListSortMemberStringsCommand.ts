...
/**
 * Sorts a list in-place by keyed member strings.
 */
export class ListSortMemberStringsCommand extends ListSortMembersCommand {
    /**
     * Metadata on the command.
     */
    private static metadata: CommandMetadata = new CommandMetadata(CommandNames.ListSortMemberStrings)
        .withDescription("Sorts a list in-place by keyed member strings")
        .withParameters([
    ...
    public getMetadata(): CommandMetadata {
        return ListSortMemberStringsCommand.metadata;
    }
    ...
    protected getSortMembersForm(): ListSortMembersSyntax {
        return this.language.syntax.lists.sortMemberStrings;
    }
}
