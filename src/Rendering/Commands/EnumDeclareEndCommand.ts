 ...
 */
export class EnumDeclareEndCommand extends Command {
    /**
     * Metadata on the command.
     */
    private static metadata: CommandMetadata = new CommandMetadata(CommandNames.EnumDeclareEnd)
    ...
    public getMetadata(): CommandMetadata {
        return EnumDeclareEndCommand.metadata;
    }
    ...
    public render(parameters: string[]): LineResults {
        const ender: string = this.renderEnumDeclareEnd();
     ...
     */
    protected renderEnumDeclareEnd(): string {
